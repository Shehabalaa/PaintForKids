...
{
	if (start.y > UI.ToolBarHeight +1 && start.y < UI.height - UI.StatusBarHeight  && end.y > UI.ToolBarHeight +1 && end.y < (UI.height - UI.StatusBarHeight -1) && start.x < UI.width -15 && end.x < UI.width -15 && start.x >0 && end.x >0)
	{
		return true;
	}
	else 
